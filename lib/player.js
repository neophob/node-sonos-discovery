  ...
  _this.getFavorites(function (error, favorites) {
    ...
    favorites.forEach(function (item) {
      if (item.title.toLowerCase() == decodeURIComponent(favorite).toLowerCase()) {
        ...
        if (item.uri.startsWith('x-sonosapi-stream:') || item.uri.startsWith('x-sonosapi-radio:') || item.uri.startsWith('pndrradio:') || item.uri.startsWith('x-sonosapi-hls:') ||bite.uri.startsWith('x-sonosprog-http')) {
